...
$result1=mysqli_query($dbc,"SELECT dbget FROM form ")
...
{ ?>
<form id="form1" name="form1" method="post" action="mfadd1.php" enctype="multipart/form-data" onsubmit="return validateForm()">

<?php }  else {?>

  <form id="form1" name="form1" method="post" action="mfadd2.php" enctype="multipart/form-data" onsubmit="return validateForm()">
