...
<tr>
    ...
    <td><a href="elistalldet.php?id=<?php echo $row['did'] ?>" class="btn btn-default" role="button">Details</a></td>
    <!--<td><a href="tlistallupd.php?id=<?php echo $row['did'] ?>" class="btn btn-default" role="button">Update</a></td>-->
</tr>
