...
$result=mysqli_query($dbc,"SELECT * FROM exec WHERE eid = '$_SESSION[eid]'")
...
$sql = "UPDATE exec SET ename='$name', epass='$pass', eemail='$email' WHERE eid = '$id'";
...
if($result) //success  
     {
      ...
      Print '<script>window.location.assign("eprofile.php?id='.$id.'");</script>'; 
    }
    else //unsuccess  
    {
      mysqli_rollback($dbc);
...
<div class="w3-container w3-dark-gray" width="100">
  <center><h1>EXECUTIVE PROFILE</h1></center>
</div>
...
<form action="eprofileupd.php?id=<?php echo $id; ?>" method="post"  name="form1" onsubmit="return validateForm()"> 
<table align="center">
<div class="box" >
...
<tr>
  ...
  <td><fieldset disabled>
    <input  class="form-control" type="text" style="background-color:#99s9999; font-weight:bold;" name="fid" maxlength="10" value='<?=$row['eid'];?>' required></fieldset>
  </td>
</tr>
<tr>
  <td>Name:</td>
  <td>
    <input  class="form-control" type="text" style="background-color:#99s9999; font-weight:bold;" name="fname" maxlength="20" value='<?=$row['ename'];?>' required>
  </td>
</tr>
<tr>
  <td>Password:</td>
  <td>
    <input  class="form-control" type="password" style="background-color:#99s9999; font-weight:bold;" name="fpass" maxlength="20" value='<?=$row['epass'];?>' required>
  </td>
</tr>
<tr>
  <td>Email:</td>
  <td>
    <input  class="form-control" type="text" style="background-color:#99s9999; font-weight:bold;" name="femail" maxlength="30" value='<?=$row['eemail'];?>' required>
  </td>
</tr>
