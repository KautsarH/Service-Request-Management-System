...
$extension = substr($name, strpos($name, '.') + 1);
	...
	$sql="INSERT INTO `servicerequests`.`form`(`dname`,`dbget`,`dtot`,`dmode`,`dpto`,`daddr`,`ddesc`,`ddate`,`sid_fk`,`mid_fk`,`tid_fk`,`exec`,`m`,`t`,`name`,`type`,`size`,`location`) VALUES ('$dname','$budget','$total','$mode','$payto','$addr','$ddesc','$ddate','$sid','$mid','$tid','$exec','$m','$t','$name','$type','$size','$target_file')";
	}
...
{	$did2 = mysqli_insert_id($dbc);
	mysqli_commit($dbc);
	print'<script> window.location.assign("sfadd3.php?id='.$did2.'");</script>'; //nama file input form
}
