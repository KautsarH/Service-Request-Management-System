...
or die("There are no records to display ... \n" . mysql_error()); 
 ...
 if(isset($_POST['sort'])){
  if($_POST['sort'] == 'name'){
    $result=mysqli_query($dbc,"SELECT * FROM `staff` order by sname") or die("There are no records to display ... \n" . mysql_error()); 
    mysqli_commit($dbc);
  }

  if($_POST['sort']=='id'){

    $result=mysqli_query($dbc,"SELECT * FROM `staff` order by sid") or die("There are no records to display ... \n" . mysql_error()); 
    mysqli_commit($dbc);
  }
}
...
<tr>
    ...
    <td><a href="astaffdet.php?id=<?php echo $row['sid'] ?>" class="btn btn-default" role="button">Details</a></td>
    <td><a href="astaffupd.php?id=<?php echo $row['sid'] ?>" class="btn btn-default" role="button">Update</a></td>
    <td><a href="astaffdel.php?id=<?php echo $row['sid'] ?>" class="btn btn-default" role="button">Delete</a></td>
</tr>
