...
$query1 = "SELECT * FROM `topm` where tid='$id'";
...
$sql = "UPDATE topm SET tpass='$pass', tid='$id', tname='$name', temail='$email' WHERE tid = '$id'";
...
<form action="atopmupd.php?id=<?php echo $id; ?>" method="post" name="form1" onclick="return validateFOrm()"> 
<table align="center">
<div class="box" >
...
<tr>
  <td> ID:</td>
  <td>
    <input  class="form-control" type="text" style="background-color:#99s9999; font-weight:bold;" name="fid" maxlength="10" value='<?=$row['tid'];?>' required>
  </td>
</tr>
<tr>
  <td>Name:</td>
