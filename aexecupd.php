...
$id = $_GET['id'];
$query1 = "SELECT * FROM `exec` where eid='$id'";
...
$id= addslashes( $_POST['fid'] );

$sql = "UPDATE exec SET epass='$pass', eid='$id', ename='$name', eemail='$email' WHERE eid = '$id'";
...
if($result) //success  
     {
      ...
      Print '<script>window.location.assign("alistexec.php?id='.$id.'");</script>'; 
    }
    else //unsuccess  
    {
      mysqli_rollback($dbc);
...
<form action="aexecupd.php?id=<?php echo $id; ?>" method="post" name="form1" onclick="return validateFOrm()"> 
<table align="center">
<div class="box" >
...
<tr>
  <td> ID:</td>
  <td>
    <input  class="form-control" type="text" style="background-color:#99s9999; font-weight:bold;" name="fid" maxlength="10" value='<?=$row['eid'];?>' required>
  </td>
</tr>
<tr>
  <td>Name:</td>
