...
if (loginForm.fid.value=="")
{
errorMessage+="ID not filled!\n";
validationVerified=false;
}
if(loginForm.fpass.value=="")
{
...
if (registerForm.femail.value=="")
{
errorMessage+="Email not filled!\n";
validationVerified=false;
}
if(registerForm.fpass.value=="")
{
...
if (!isValidEmail(registerForm.femail.value)) {
errorMessage+="Invalid email address provided!\n";
validationVerified=false;
}
if(!validationVerified)
