...
<script>
  ...
  <a href="mlist.php" class="w3-bar-item w3-button">My Request List</a>
   <a href="mlistall.php" class="w3-bar-item w3-button">All Request List</a>
    <a href="mlogout.php" class="w3-bar-item w3-button">Logout</a>
...
<tr>
    ...
    <td><a href="mformdet.php?id=<?php echo $row['did'] ?>" class="btn btn-default" role="button">Details</a></td>
</tr>
