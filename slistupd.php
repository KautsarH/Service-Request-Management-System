...
<!--<tr>
    <td><label for="fattch">Attachment</label></td>
    <td><input name="fileToUpload" type="file" id="fileToUpload" value='<?=$row['location'];?>'/></td>
  </tr>
  <tr>
    <td>Current file :</td>
    <t<?php echo $attch;?></td>
  ...
  <tr>
    <td colspan="2"><p>*File must not exceed 8 MB. One file per form</p></td>
    
  </tr>-->
<tr><div class="w3-container" >
  <td></td>
     <td> <input  class="w3-btn w3-teal" id="submit" type="submit" name="update" value="Update"></td>
</div>
</tr>
</table>
</div>
