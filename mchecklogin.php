...
$sql="SELECT * FROM manager WHERE mid='$fid' and mpass='$fpass'";
...
print'<script> window.location.assign("mchecklogin.php"));</script>';
}
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('img/arrows-box-business-533189.jpg');">
      <div class="wrap-login100">
        <form class="login100-form validate-form" method="post" action="schecklogin.php">
          ...
          <div class="wrap-input100 validate-input" data-validate = "Enter username">
            <input class="input100" type="text" name="fid" id="fid" placeholder="Manager ID">
          ...
          <div class="text-center p-t-90">
            <a class="txt1" href="manager/fmadd.php">
              Create account
            </a>
          </div>
        </form>
